...
public class GoodsReviewDetailServiceImpl implements GoodsReviewDetailService {
 ...
 // 获取商品评价列表
    ...
    public void addGoodsReviewDetail(GoodsReviewDetail reviewDetail) {
        // 获取原来的评价数据
    GoodsReviewDetail originReviewDetail = goodsReviewDetailMapper.getGoodsReviewsByGoodsId(reviewDetail.getGoodsId()).get(0);

        
        // 将原来的评价数据中的goodsId和goodsName复制到新的评价数据中
        reviewDetail.setGoodsId(originReviewDetail.getGoodsId());
